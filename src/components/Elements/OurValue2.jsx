...
import img1 from "./../../images/video-bg2.jpg";
import img2 from "./../../images/Signature+Black.png";
                ...
                <div className="col-md-5 col-sm-6">
                  ...
                  <div className="video-part-2">
                    ...
                    <ul className="list-angle-right anchor-line">
                      <li>
                        <NavLink to="/about">Construction Management</NavLink>
                      </li>
                      <li>
                        <NavLink to="/about">Pre Construction Services</NavLink>
                      </li>
                      <li>
                        <NavLink to="/about">Contract Administration</NavLink>
                      </li>
                    </ul>
                  </div>
                  {/* TITLE END */}
                  <div className="author-info author-info-v2 p-t20">
                    <div className="author-signature">
                      <img src={img2} alt="Signature" width={150} />
                    </div>
