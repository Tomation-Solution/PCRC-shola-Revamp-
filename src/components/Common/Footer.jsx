              ...
              <div className="row">
                <div className="col-md-8 col-sm-8">
                  <div className="call-to-action-left text-black">
                    ...
                    <span>
                      Never Miss Anything From PCRCLAGOS By Signing Up To Our
                      Newsletter.
                    </span>
                  </div>
                </div>
                ...
                <div className="col-lg-3 col-md-6 col-sm-6">
                  <div className="widget widget_about">
                    ...
                    <div
                      ...
                      className="logo-footer clearfix p-b15"
                    >
                      <NavLink to={"./"}>
                    ...
                    <ul className="social-icons  mt-social-links">
                      ...
                      <li>
                        <a
                          href={"https://www.instagram.com/pcrc_lagos_state/"}
                          target={"_blank"}
                      ...
                      <li>
                        <a
                          href={
                            "https://web.facebook.com/groups/1459834440813251"
                          }
                      ...
                      <li>
                        <a
                          href={"https://twitter.com/LagosPcrc"}
                ...
                <div className="col-lg-3 col-md-6 col-sm-6">
                  <div className="widget widget_address_outer">
                    ...
                    <ul className="widget_address">
                      <li>
                        {" "}
                        PCRC HALL Area H Command Head Quarters, Ogudu Ojota,
                        Lagos State, Nigeria
                      </li>
                      <li>info@pcrclagosstate.org.ng</li>
                      <li> +234 802 321 7199</li>
                      <li> +234 802 307 7348</li>
                    </ul>
                  </div>
                </div>
                {/* USEFUL LINKS */}
            ...
            <div className="container">
              <div className="row">
                <div className="mt-footer-bot-center">
                  <span className="copyrights-text">© 2023 PCRCLAGOS</span>
                </div>
              </div>
            </div>
          </div>
